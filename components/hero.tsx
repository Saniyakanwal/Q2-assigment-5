...
const Hero = () => {
  return (
    ...
    <div className="w-1/2 flex flex-col justify-center items-start m-5">
      <h1 className="text-[40px] w-[496px]  mt-[3l6px] ml-44 ">IMPECCABLE CRAFTSMANSHIP AND FINESSE</h1>
    ...
    <div className="w-1/2 flex mt-[198px] ml-24 justify-center items-center">
